...
<main class="py-24 bg-slate-50 min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full bg-white p-12 rounded-[3.5rem] shadow-2xl shadow-slate-200 border border-slate-100 mx-4">
        <div class="text-center mb-10">
            <h1 class="text-4xl font-black text-slate-900 mb-4"><?php echo __('login'); ?></h1>
            <p class="text-slate-400 font-medium italic">Content de vous revoir sur FreeGeny !</p>
        </div>
        ...
        <div class="mt-10 text-center">
            <p class="text-slate-400 text-sm">Pas encore de compte ? 
                <a href="/<?php echo $country; ?>-<?php echo $lang; ?>/auth/register" class="text-orange-600 font-black hover:underline uppercase tracking-widest ml-1">S'inscrire</a>
            </p>
        </div>
    </div>
</main>
