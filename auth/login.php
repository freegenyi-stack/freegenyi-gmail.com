    ...
    <div class="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-center gap-20 relative z-10">
        ...
        <div class="w-full max-w-md">
            <div class="glass-card rounded-[3.5rem] shadow-[0_45px_100px_rgba(0,0,0,0.07)] border border-white p-10 pt-14 relative">
                ...
                <!-- Bouton Google -->
                <a href="/api/auth/google.php" class="flex items-center justify-center gap-3 w-full border-2 border-slate-100 hover:border-orange-400 bg-white hover:bg-orange-50 text-slate-700 font-bold py-3.5 rounded-2xl transition-all duration-200 shadow-sm mb-5 group">
