    ...
    if (H5P.isFramed) {
      ...
      if (H5P.externalEmbed === false) {
        ...
        var resizeIframe = function () {
          try {
            if (window.parent.H5P && window.parent.H5P.isFullscreen) {
...
H5P.fullScreen = function ($element, instance, exitCallback, body, forceSemiFullScreen) {
  ...
  if (H5P.isFramed && H5P.externalEmbed === false) {
    try {
      if (window.parent.H5P && window.parent.H5P.fullScreen) {
      ...
      /* parent without H5P runtime (Mon Atelier iframe) */
    }
  }
...
H5P.t = function (key, vars, ns) {
  ...
  if (!H5PIntegration.l10n || H5PIntegration.l10n[ns] === undefined) {
  ...
  $(document).ready(function () {
    ...
    if (H5P.isFramed && H5P.externalEmbed === false) {
      try {
        ...
        /* parent page without H5P runtime (Mon Atelier iframe) */
      }
    }
