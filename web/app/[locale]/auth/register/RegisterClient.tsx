...
const dict = {
    ...
    pl: {
        vosAcces: "Dane dostępu",
        lAlliance: "Partner edukacyjny",
        sonProfil: "Profil dziecka",
        stepText: "Ekran {step} z 3",
        chooseRole: "Wybierz rolę",
        parentTab: "Rodzice",
        schoolTab: "Szkoła",
        ngoTab: "Organizacje",
        instantGoogle: "Szybkie logowanie przez Google",
        orEmail: "Lub ręcznie przez e-mail",
        fullNameParent: "Imię i nazwisko",
        fullNameSchool: "Nazwa instytucji",
        fullNameNgo: "Nazwa organizacji",
        fullNamePlaceholderParent: "Np: Jan Kowalski",
        fullNamePlaceholderSchool: "Np: Szkoła Podstawowa nr 1",
        fullNamePlaceholderNgo: "Np: Polski Czerwony Krzyż",
        username: "Nazwa użytkownika",
        usernamePlaceholder: "jan_kowalski",
        email: "E-mail",
        ...
        confirmPasswordPlaceholder: "••••••••",
        matchPerfect: "Dopasowanie idealne",
        matchError: "Hasła nie pasują",
        eightChars: "8 znaków",
        ...
        next: "Dalej",
        previous: "Wstecz",
        titleParentStep1: "Budzenie",
        titleParentStep1Orange: "Elity",
        titleSchoolStep1: "Budzenie",
        titleSchoolStep1Orange: "Elity",
        titleNgoStep1: "Budzenie",
        titleNgoStep1Orange: "Elity",
        subStep1Parent: "Bądź architektem wyjątkowego losu swoich dzieci.",
        subStep1School: "Wyjątkowy partner edukacyjny dla elity przyszłości.",
        subStep1Ngo: "Wspólnie budujemy lepszą przyszłość dla naszych dzieci.",
        // Left Pane Titles/Subs
        leftTitle1: "Budzenie",
        leftTitle1Orange: "Elity",
        leftSub1: "Bądź architektem wyjątkowego losu swoich dzieci.",
        leftTitle2: "Harmonia",
        leftTitle2Orange: "Partnerzy",
        leftSub2: "Uzgodnij związek dla wspólnego startu swoich dzieci.",
        leftTitle3: "Wznoszenie",
        leftTitle3Orange: "Genialność",
        leftSub3: "Oświetl ich drogę wznoszenia ku doskonałości.",
        // Step 2 Parent
        allyTitle: "Twój partner edukacyjny",
        allyDesc: "Edukacja to praca zespołowa. Zaproś osobę, która Cię wspiera (małżonek, starsze dziecko, wujek...), aby skoordynować Wasze wysiłki.",
        allyNamePlaceholder: "Np: Jan lub Anna",
        allyEmailPlaceholder: "E-mail partnera (opcjonalnie)",
        // Step 2 School
        schoolIdentityTitle: "Tożsamość instytucji",
        schoolIdentityDesc: "Przygotuj oficjalne informacje o swojej szkole podstawowej, aby potwierdzić nasze partnerstwo edukacyjne.",
        privateSchool: "Szkoła prywatna",
        publicSchool: "Szkoła publiczna",
        schoolAddressPlaceholder: "Pełny adres siedziby",
        schoolManagerPlaceholder: "Nazwisko odpowiedzialnego/dyrektora",
        // Step 2 NGO
        ngoTitle: "Zobowiązanie solidarnościowe",
        ngoDesc: "Określ obszar swojej działalności humanitarnej dla idealnej harmonii.",
        ngoDomainPlaceholder: "Obszar działalności",
        ngoDomainEducation: "Edukacja i wsparcie",
        ngoDomainSocial: "Integracja społeczna",
        ngoDomainCulture: "Kultura i świadomość",
        ngoDomainHumanitarian: "Kompleksowa działalność humanitarna",
        ngoAddressPlaceholder: "Adres siedziby społecznej",
        ngoManagerPlaceholder: "Odpowiedzialny za organizację",
        // Step 3 Parent
        childFirstName: "Imię dziecka",
        childFirstNamePlaceholder: "Np: Zuzanna lub Adam",
        childAge: "Wiek",
        childAgePlaceholder: "Np: 8",
        childLevel: "Poziom",
        childSchool: "Szkoła / Instytucja",
        childSchoolPlaceholder: "Szukaj szkoły...",
        securityCheck: "Weryfikacja bezpieczeństwa",
        securityCheckDesc: "System ochrony przed botami",
        securityCodePlaceholder: "Wprowadź kod",
        finalizeButton: "Zakończ rejestrację",
        registerSchoolButton: "Zarejestruj instytucję",
        registerNgoButton: "Zarejestruj organizację",
        termsText: "Kontynuując, zgadzasz się z naszymi warunkami i polityką prywatności.",
        alreadyHaveAccount: "Masz już konto?",
        loginLink: "Zaloguj się",
        // Step 3 School
        digitalPresence: "Obecność cyfrowa",
        digitalPresencePlaceholderSchool: "Strona internetowa lub Facebook (np: fb.com/szkola...)",
        schoolDimension: "Rozmiar instytucji",
        classesCountPlaceholder: "Liczba klas podstawowych",
        instCheck: "Weryfikacja instytucjonalna",
        instCheckDesc: "Potwierdź oficjalny status szkoły",
        beneficiariesCount: "Liczba beneficjentów",
        beneficiariesPlaceholder: "Liczba uczniów",
        orgCheck: "Weryfikacja organizacji",
        orgCheckDesc: "Potwierdź oficjalny status organizacji",
        errNameEmpty: "Wprowadź swoje imię i nazwisko",
        errUsernameEmpty: "Wybierz nazwę użytkownika",
        errUsernameTaken: "Nazwa użytkownika jest już zajęta",
        errEmailEmpty: "Wprowadź swój adres e-mail",
        errPasswordEmpty: "Wprowadź hasło",
...
export default function RegisterClient({ locale }: { locale: string }) {
    ...
    const [childCountry, setChildCountry] = useState(regionCountry || (isNorwegian ? "NO" : (isFinnish || isFinnishSwedish ? "FI" : (isDutch ? "NL" : (isPortuguese ? "PT" : (isSpanish ? "AR" : (isPolish ? "PL" : (isCzech ? "CZ" : (isJapanese ? "JP" : (regionCountry === "BR" ? "BR" : (regionCountry === "CL" ? "CL" : (regionCountry === "CO" ? "CO" : (regionCountry === "SG" ? "SG" : "DZ")))))))))))));
