    ...
    <div className="min-h-screen flex items-center justify-center p-8 text-white relative overflow-hidden bg-slate-950" dir={isRTL ? "rtl" : "ltr"}>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4">
          <button className={cn("bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-3xl font-black uppercase tracking-widest text-sm transition-all shadow-xl hover:shadow-blue-900/40", isRTL && "font-ui-ar text-2xl tracking-normal")}>
            {t("CTA")}
          </button>
          <Link href="/dashboard/child-lobby" className={cn("inline-flex items-center justify-center gap-2 text-blue-400 font-bold uppercase tracking-widest text-xs hover:text-white transition-colors mt-4", isRTL && "flex-row-reverse font-ui-ar text-xl tracking-normal")}>
