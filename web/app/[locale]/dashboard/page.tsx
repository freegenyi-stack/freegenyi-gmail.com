    ...
    <div className="min-h-screen bg-slate-50/50 pb-20" dir={isRTL ? "rtl" : "ltr"}>
      <div className="max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className={cn("flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-16", isRTL && "md:flex-row-reverse")}>
          ...
          >
            <h1 className={cn("text-4xl font-extrabold text-slate-900 tracking-tight", isRTL && "font-ui-ar text-5xl")}>{t("Title")}</h1>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className={cn("flex items-center gap-3 bg-white border border-slate-200 px-8 py-4 rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:shadow-xl transition-all shadow-sm", isRTL && "flex-row-reverse font-ui-ar text-lg tracking-normal")}
          >
                ...
                <div className="relative z-10">
                  <div className={cn("flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-12", isRTL && "md:flex-row-reverse")}>
                    <div className={cn("flex items-center gap-6", isRTL && "flex-row-reverse")}>
                      ...
                      <div className={isRTL ? "text-right" : "text-left"}>
                        <h2 className={cn("text-3xl font-extrabold text-slate-900 tracking-tight", isRTL && "font-ui-ar text-4xl")}>{child.name}</h2>
                        <div className={cn("flex items-center gap-2 mt-1", isRTL && "flex-row-reverse")}>
                          <span className={cn("text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400", isRTL && "font-ui-ar text-base tracking-normal")}>{t("ChildCard.Level")} : {child.grade}</span>
                          <span className="w-1.5 h-1.5 bg-slate-200 rounded-full" />
                          <span className={cn("text-[10px] font-bold uppercase tracking-[0.2em] text-orange-600", isRTL && "font-ui-ar text-base tracking-normal")}>{t("ChildCard.Premium")}</span>
                        </div>
                      </div>
                    </div>
                    <button className={cn("w-full md:w-auto bg-slate-950 text-white px-10 py-5 rounded-2xl text-[11px] font-bold uppercase tracking-widest hover:bg-orange-600 transition-all shadow-xl hover:shadow-orange-200/50", isRTL && "font-ui-ar text-xl tracking-normal")}>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                    {[
                      ...
                      <div key={stat.label} className="bg-slate-50/50 p-6 rounded-3xl border border-slate-100/50 flex flex-col items-center justify-center text-center group/stat hover:bg-white hover:shadow-md transition-all">
                        ...
                        <p className={cn("text-[9px] font-bold text-slate-400 uppercase tracking-widest mb-1", isRTL && "font-ui-ar text-sm tracking-normal")}>{stat.label}</p>
                        <p className={cn(
                          "text-xl font-semibold truncate w-full",
                          stat.highlight ? "text-orange-600" : "text-slate-900",
                          isRTL && "font-ui-ar text-2xl"
                        )}>
                          {stat.value}
                        </p>
                      </div>
                  ...
                  >
                    <div className={cn("flex items-center gap-5", isRTL && "flex-row-reverse")}>
                      ...
                      <div className={isRTL ? "text-right" : "text-left"}>
                        <h4 className={cn("text-sm font-bold text-orange-950 uppercase tracking-tight", isRTL && "font-ui-ar text-lg")}>{t("ChildCard.EmotionalBoost.Title")}</h4>
                    ...
                    <button className={cn("bg-white text-orange-600 px-8 py-3.5 rounded-2xl text-[10px] font-bold uppercase tracking-widest shadow-sm hover:shadow-xl transition-all border border-orange-100", isRTL && "font-ui-ar text-lg tracking-normal")}>
          ...
          <div className="space-y-12">
            ...
            >
              <div className={cn("flex items-center gap-4 mb-8", isRTL && "flex-row-reverse")}>
                ...
                <h3 className={cn("text-xl font-semibold text-slate-900 leading-tight", isRTL && "font-ui-ar text-2xl")}>{t("Alliance.Title")}</h3>
              </div>
              ...
              <div className={cn("flex items-center gap-4 mb-8 p-4 bg-slate-50/50 rounded-2xl border border-slate-100", isRTL && "flex-row-reverse")}>
                ...
                <div className={cn("min-w-0 flex-1", isRTL && "text-right")}>
                  ...
                  <div className={cn("flex items-center gap-1.5 mt-0.5", isRTL && "flex-row-reverse")}>
                    ...
                    <p className={cn("text-[9px] font-bold text-orange-600 uppercase tracking-widest", isRTL && "font-ui-ar text-sm tracking-normal")}>{t("Alliance.CoParent")} · {t("Alliance.Online")}</p>
                  </div>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-3">
                <button className={cn("flex items-center justify-center gap-2 bg-slate-950 text-white py-4 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-orange-600 transition-all shadow-lg shadow-slate-900/10", isRTL && "font-ui-ar text-lg tracking-normal")}>
                  <MessageSquare className="w-3 h-3" /> {t("Alliance.Message")}
                </button>
                <button className={cn("flex items-center justify-center gap-2 bg-white border border-slate-200 text-slate-700 py-4 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-slate-50 transition-all shadow-sm", isRTL && "font-ui-ar text-lg tracking-normal")}>
            ...
            >
              <div className={cn("flex items-center gap-4 mb-8", isRTL && "flex-row-reverse")}>
                ...
                <h3 className={cn("text-xl font-semibold text-slate-900 leading-tight", isRTL && "font-ui-ar text-2xl")}>{t("Printable.Title")}</h3>
              </div>
              <p className={cn("text-sm text-slate-500 font-normal leading-relaxed mb-8", isRTL && "font-lateef text-xl")}>
                {t("Printable.Desc")}
              </p>
              <button className={cn("w-full bg-slate-950 text-white py-4 rounded-2xl text-[10px] font-bold uppercase tracking-widest hover:bg-blue-600 transition-all shadow-xl shadow-slate-900/10", isRTL && "font-ui-ar text-xl tracking-normal")}>
                {t("Printable.CTA")}
              </button>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                <span className={cn("text-[10px] font-bold uppercase tracking-widest text-orange-500 mb-6 block", isRTL && "font-ui-ar text-base")}>{t("Bridge.Tag")}</span>
                <p className={cn("text-xl font-semibold leading-relaxed mb-10", isRTL && "font-ui-ar text-2xl leading-snug")}>
                  "{childrenData[0].name} a excellé en Maths. Offrez-lui une partie de foot au parc ce samedi ?"
                </p>
                <div className={cn("flex gap-4", isRTL && "flex-row-reverse")}>
                  <button className={cn("flex-1 bg-orange-600 text-white py-4 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-orange-700 transition-all shadow-lg shadow-orange-600/20", isRTL && "font-ui-ar text-xl tracking-normal")}>
                    {t("Bridge.Validate")}
                  </button>
                  <button className={cn("flex-1 bg-white/10 text-white py-4 rounded-xl text-[10px] font-bold uppercase tracking-widest hover:bg-white/20 transition-all", isRTL && "font-ui-ar text-xl tracking-normal")}>
                    {t("Bridge.Ignore")}
                  </button>
                </div>
              </div>
