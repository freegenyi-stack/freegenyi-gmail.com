            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                <motion.div key="step1" initial={{ opacity: 0, x: isRTL ? 30 : -30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: isRTL ? -30 : 30 }} className="space-y-6">
                  <h1 className={cn("text-5xl md:text-6xl font-extrabold leading-tight tracking-tighter text-white", isRTL && "font-amiri")}>{t("LeftPanel.Step1.Title")}</h1>
                  <div className={cn("grid grid-cols-2 gap-4 text-[12px] font-semibold text-slate-500 uppercase tracking-widest leading-relaxed", isRTL && "font-amiri text-lg tracking-normal")}>
              ...
              {step === 2 && (
                <motion.div key="step2" initial={{ opacity: 0, x: isRTL ? 30 : -30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: isRTL ? -30 : 30 }} className="space-y-6">
                  <h1 className={cn("text-5xl md:text-6xl font-extrabold leading-tight tracking-tighter text-white", isRTL && "font-amiri")}>{t("LeftPanel.Step2.Title")}</h1>
                  <p className={cn("text-blue-400 font-semibold text-sm tracking-[0.2em] uppercase", isRTL && "font-amiri text-xl tracking-normal")}>{t("LeftPanel.Step2.Subtitle")}</p>
                </motion.div>
              )}
              {step === 3 && (
                <motion.div key="step3" initial={{ opacity: 0, x: isRTL ? 30 : -30 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: isRTL ? -30 : 30 }} className="space-y-6">
                  <h1 className={cn("text-5xl md:text-6xl font-extrabold leading-tight tracking-tighter text-white", isRTL && "font-amiri")}>{t("LeftPanel.Step3.Title")}</h1>
                  <p className={cn("text-green-400 font-semibold text-sm tracking-[0.2em] uppercase italic", isRTL && "font-amiri text-xl tracking-normal")}>{t("LeftPanel.Step3.Subtitle")}</p>
                </motion.div>
              )}
            </AnimatePresence>
          </div>
            ...
            <AnimatePresence mode="wait">
              {step === 1 && (
                <motion.div key="form1" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-10">
                  <div className="text-center space-y-4">
                    <h2 className={cn("text-4xl font-extrabold text-slate-900 tracking-tight", isRTL && "font-amiri text-5xl")}>{t("Form.Step1.Greeting")}</h2>
                    <p className={cn("text-slate-400 font-semibold text-[10px] uppercase tracking-[0.2em] italic", isRTL && "font-amiri text-lg tracking-normal")}>{t("Form.Step1.Tag")}</p>
                  </div>
                  <div className="space-y-8">
                    <div className={cn("grid grid-cols-3 gap-3", isRTL && "flex-row-reverse")}>
                      {(["Maman", "Papa", "Tuteur"] as const).map((role) => (
                        <button key={role} onClick={() => setData({ ...data, role })} className={cn("py-4 border-2 rounded-2xl text-center font-bold transition-all uppercase text-[10px] h-14 flex items-center justify-center", data.role === role ? "bg-slate-950 text-white border-slate-950 shadow-lg" : "bg-white text-slate-400 border-slate-100 hover:border-slate-200", isRTL && "font-amiri text-base")}>{role}</button>
                      ))}
                    </div>
                    <div className="space-y-2">
                      <label className={cn("text-[10px] font-bold uppercase tracking-widest text-slate-300 ml-1", isRTL && "font-amiri text-sm tracking-normal")}>{t("Form.Step1.PhoneLabel")}</label>
                  ...
                  <button onClick={nextStep} disabled={!data.phone} className={cn("w-full bg-slate-950 text-white py-5 rounded-2xl font-bold uppercase tracking-widest text-[11px] shadow-xl hover:bg-orange-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed group", isRTL && "font-amiri text-xl tracking-normal")}>
              ...
              {step === 2 && (
                <motion.div key="form2" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-10">
                  <div className="text-center space-y-4">
                    <h2 className={cn("text-4xl font-extrabold text-slate-900 tracking-tight", isRTL && "font-amiri text-5xl")}>{t("Form.Step2.Title")}</h2>
                    <p className={cn("text-slate-400 font-semibold text-[10px] uppercase tracking-[0.2em] italic", isRTL && "font-amiri text-lg tracking-normal")}>{t("Form.Step2.Tag")}</p>
                  </div>
                  ...
                  <div className={cn("flex gap-4", isRTL && "flex-row-reverse")}>
                    ...
                    <button onClick={nextStep} className={cn("flex-1 bg-slate-950 text-white py-5 rounded-2xl font-bold uppercase tracking-widest text-[11px] shadow-xl hover:bg-blue-600 transition-all", isRTL && "font-amiri text-xl tracking-normal")}>{t("Form.Step2.Next")}</button>
                  </div>
                </motion.div>
              )}
              ...
              {step === 3 && (
                <motion.div key="form3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-8">
                  <div className="text-center space-y-4">
                    <h2 className={cn("text-4xl font-extrabold text-slate-900 tracking-tight", isRTL && "font-amiri text-5xl")}>{t("Form.Step3.Title")}</h2>
                    <p className={cn("text-orange-600 font-semibold text-[10px] uppercase tracking-[0.2em] italic", isRTL && "font-amiri text-lg tracking-normal")}>{t("Form.Step3.Tag")}</p>
                  </div>
                  <div className="grid grid-cols-1 gap-4 overflow-y-auto max-h-[400px] pr-2 custom-scroll">
                    <div className="space-y-2">
                      <label className={cn("text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1", isRTL && "font-amiri text-sm tracking-normal mr-1")}>{t("Form.Step3.ChildName")}</label>
                    ...
                    <div className={cn("grid grid-cols-2 gap-4", isRTL && "flex-row-reverse")}>
                      <div className="space-y-2">
                        <label className={cn("text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1", isRTL && "font-amiri text-sm tracking-normal mr-1")}>{t("Form.Step3.Country")}</label>
                        <select
                      ...
                      <div className="space-y-2">
                        <label className={cn("text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1", isRTL && "font-amiri text-sm tracking-normal mr-1")}>{t("Form.Step3.Level")}</label>
                    ...
                    <div className={cn("grid grid-cols-2 gap-4", isRTL && "flex-row-reverse")}>
                      <div className="space-y-2">
                        <label className={cn("text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1", isRTL && "font-amiri text-sm tracking-normal mr-1")}>{t("Form.Step3.Age")}</label>
                      ...
                      <div className="space-y-2">
                        <label className={cn("text-[9px] font-bold text-slate-400 uppercase tracking-widest ml-1", isRTL && "font-amiri text-sm tracking-normal mr-1")}>{t("Form.Step3.Region")}</label>
                  ...
                  <div className={cn("flex gap-4 pt-4", isRTL && "flex-row-reverse")}>
                    ...
                    <button onClick={() => (window.location.href = "/dashboard")} className={cn("flex-1 bg-green-600 text-white py-5 rounded-2xl font-bold uppercase tracking-widest text-[11px] shadow-xl hover:bg-slate-950 transition-all", isRTL && "font-amiri text-xl tracking-normal")}>{t("Form.Step3.CTA")}</button>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
