                ...
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            {isLogin ? "Connectez-vous pour continuer" : "Rejoignez FreeGeny dès maintenant"}
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleEmailAuth} className="space-y-4">
                        ...
                        {isLogin && (
                            <div className="flex items-center justify-between">
                                ...
                                <Link href="/auth/forgot-password" className="text-sm font-medium text-violet-600 hover:text-violet-500">
                                    Mot de passe oublié ?
                                </Link>
                            </div>
                        )}
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-violet-600 via-indigo-600 to-purple-700 items-center justify-center p-12 relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-lg text-center">
                    ...
                    <h2 className="text-3xl font-bold text-white mb-4">
                        Chaque enfant est un génie qui sommeille
                    </h2>
                    <p className="text-lg text-white/80">
                        FreeGeny transforme chaque moment en opportunité d'apprendre, de grandir et de s'émerveiller.
                    </p>

                    <div className="mt-8 flex justify-center gap-8">
                        <div className="text-center">
                            <div className="text-3xl font-bold text-white">38+</div>
                            <div className="text-sm text-white/70 flex items-center gap-1"><Globe className="h-4 w-4" /> Pays</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-white">10k+</div>
                            <div className="text-sm text-white/70 flex items-center gap-1"><Sparkles className="h-4 w-4" /> Élèves</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-white">500+</div>
                            <div className="text-sm text-white/70 flex items-center gap-1"><BookOpen className="h-4 w-4" /> Exercices</div>
                        </div>
                    </div>
                </div>
            </div>
