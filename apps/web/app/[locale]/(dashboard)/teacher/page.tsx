...
import ExerciseWizard from '@/components/dashboard/exercises/wizard';
    ...
    return (
        <div className="animate-in fade-in duration-500 space-y-8">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
                ...
                <div className="rounded-2xl border bg-white p-8">
                    <h3 className="font-bold text-xl mb-6">Outils Pédagogiques</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <Dialog open={isWizardOpen} onOpenChange={setIsWizardOpen}>
                            <DialogTrigger asChild>
                                <button className="p-6 rounded-2xl border border-dashed flex flex-col items-center justify-center gap-3 hover:bg-slate-50 transition-all group">
                            ...
                            <DialogContent className="max-w-4xl h-[90vh] p-0 overflow-hidden border-none rounded-3xl">
                                <ExerciseWizard onClose={() => setIsWizardOpen(false)} />
                            </DialogContent>
                        </Dialog>

                        <button className="p-6 rounded-2xl border border-dashed flex flex-col items-center justify-center gap-3 hover:bg-slate-50 transition-all group">
                            <div className="p-2 rounded-full bg-slate-100 text-slate-400 group-hover:bg-primary/10 group-hover:text-primary transition-all">
