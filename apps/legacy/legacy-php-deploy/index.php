...
// CONFIGURATION
$SITE_PASSWORD = "Yousr4568520&";

if (isset($_POST['password'])) {
    if ($_POST['password'] === $SITE_PASSWORD) {
        $_SESSION['site_unlocked'] = true;
        // Simple cookie for maximum compatibility across servers
        setcookie('fg_unlocked', 'true', time() + (86400 * 30), "/");
    } else {
        $error = "Mot de passe incorrect";
    }
}

// Auto-unlock from cookie if session is lost
if (!isset($_SESSION['site_unlocked']) && isset($_COOKIE['fg_unlocked']) && $_COOKIE['fg_unlocked'] === 'true') {
    $_SESSION['site_unlocked'] = true;
}

if (isset($_SESSION['site_unlocked']) && $_SESSION['site_unlocked'] === true) {
    // SECURITY: Serve the hybrid home page directly
...
<body>
    <div class="lock-card">
        <a href="/" class="logo" style="text-decoration: none;">FreeGeny</a>
