            ...
            <div class="flex items-center space-x-8 <?php echo $is_rtl ? 'space-x-reverse' : ''; ?>">
                ...
                <div class="hidden md:block relative" x-data="{ open: false }">
                    <button @click="open = !open" 
                        ...
                        <img src="https://flagcdn.com/w40/<?php echo strtolower($country); ?>.png" class="w-7 h-auto rounded-sm group-hover:rotate-6 transition-transform">
                    ...
                    <div x-show="open" @click.away="open = false" x-cloak 
                        ...
                        <div class="grid grid-cols-1 gap-1">
                            <?php foreach ($supported_regions as $code => $info): ?>
                                <div class="p-1">
                                    <div class="flex items-center justify-between px-4 py-3 bg-slate-50/50 rounded-2xl">
                                        <div class="flex items-center space-x-3 <?php echo $is_rtl ? 'space-x-reverse' : ''; ?>">
                                            ...
                                            <span class="font-bold text-sm text-slate-700"><?php echo $info['name']; ?></span>
                                        </div>
        ...
        <div x-show="mobileMenuOpen" x-cloak class="fixed inset-0 z-[200] lg:hidden">
            ...
            <div class="absolute <?php echo $is_rtl ? 'left-0' : 'right-0'; ?> top-0 bottom-0 w-80 bg-white p-10 shadow-2xl overflow-y-auto"
                ...
                <div class="flex flex-col space-y-8">
                    <a href="/<?php echo $country; ?>-<?php echo $lang; ?>/about" class="text-2xl font-black text-slate-900 hover:text-orange-600 transition"><?php echo __('about'); ?></a>
                    <a href="/<?php echo $country; ?>-<?php echo $lang; ?>/goals" class="text-2xl font-black text-slate-900 hover:text-orange-600 transition"><?php echo __('goals'); ?></a>
                    <!-- ... rest of links ... -->
                    <a href="/<?php echo $country; ?>-<?php echo $lang; ?>/shop" class="text-2xl font-black text-slate-900 hover:text-orange-600 transition"><?php echo __('shop'); ?></a>
