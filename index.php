    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="group relative bg-white p-8 rounded-3xl shadow-xl border border-transparent hover:border-orange-200 hover:shadow-orange-100 transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-4"><?php echo __('arabic'); ?></h3>
                <p class="text-gray-600 mb-6 line-clamp-2">Alphabet, lecture, écriture et compréhension orale.</p>
                <div class="flex items-center justify-between">
                    <span class="text-sm font-bold text-orange-600">115 <?php echo __('lessons') ?? 'Leçons'; ?></span>
                    <a href="<?php echo APP_URL . '/' . $country . '-' . $lang . '/algeria/1ap/arabe'; ?>" class="p-4 bg-gray-50 rounded-xl group-hover:bg-orange-600 group-hover:text-white transition-colors duration-300">
                        →
                    </a>
                </div>
            </div>
            ...
            <div class="group relative bg-white p-8 rounded-3xl shadow-xl border border-transparent hover:border-blue-200 hover:shadow-blue-100 transition-all duration-300">
                ...
                <h3 class="text-2xl font-bold text-gray-900 mb-4"><?php echo __('maths'); ?></h3>
                <p class="text-gray-600 mb-6 line-clamp-2">Nombres, calcul, géométrie et logique.</p>
                <div class="flex items-center justify-between">
                    <span class="text-sm font-bold text-blue-600">95 <?php echo __('lessons') ?? 'Leçons'; ?></span>
                    <a href="<?php echo APP_URL . '/' . $country . '-' . $lang . '/algeria/1ap/mathematiques'; ?>" class="p-4 bg-gray-50 rounded-xl group-hover:bg-blue-600 group-hover:text-white transition-colors duration-300">
                        →
                    </a>
                </div>
            </div>
